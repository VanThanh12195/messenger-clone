...
export default function ChatRoom() {
  return (
    <>
      <div className="h-screen w-full flex antialiased text-gray-200overflow-hidden">
          ...
          <main className="flex-grow flex flex-row min-h-0">
            <section className="flex flex-col flex-none overflow-auto w-24  group lg:max-w-sm md:w-2/5 transition-all duration-300 ease-in-out">
              <div className="header p-4 flex flex-row justify-between items-center flex-none">
                ...
                <a
                  href="#"
                  className="block rounded-full hover:bg-gray-700 w-10 h-10 p-2 hidden md:block group-hover:block"
                >
                  <svg
                    viewBox="0 0 24 24"
              ...
              <div className="search-box p-4 flex-none">
                <form onsubmit="">
                  <div className="relative">
                    <label>
                      <input
                        className="rounded-full py-2 pr-6 pl-10 w-full border focus:border-gray-700 focus:bg-gray-900 focus:outline-none text-gray-200 focus:shadow-md transition duration-300 ease-in"
                        type="text"
                        defaultValue=""
